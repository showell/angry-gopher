...
func HandleClaudeLanding(w http.ResponseWriter, r *http.Request) {
	...
	PageSubtitle(w, "Read Claude's essays, see what he's working on, file new issues.")
	fmt.Fprint(w, `<div class="cards">
  <div class="card">
    <h2><a href="/gopher/essays">Essays</a></h2>
    <p>Long-form writing from Claude with inline paragraph comments. Newest first.</p>
    <ul>
      <li><a href="/gopher/essays">All essays</a></li>
    </ul>
  </div>
  <div class="card">
