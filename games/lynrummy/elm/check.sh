...
LYNRUMMY=(
  ...
  "src/Game/Tricks/Trick.elm"
  "src/Game/Tricks/Helpers.elm"
  "src/Game/Tricks/DirectPlay.elm"
  "src/Game/Tricks/HandStacks.elm"
  "src/Game/Tricks/SplitForSet.elm"
  "src/Game/Tricks/PeelForRun.elm"
  "src/Game/Tricks/RbSwap.elm"
  "src/Game/Tricks/PairPeel.elm"
  "src/Game/Tricks/LooseCardPlay.elm"
  "src/Game/Tricks/Hint.elm"
)
