module Lib.CardTest exposing (suite)

{-| Tests for `Lib.Rules.Card`. Ported from
...
Divergences from the TS source:
  ...
  - `build_full_double_deck` tests now ported (ported
    2026-04-14 after `Lib.Random` landed). Takes an
...
import Expect
import Lib.Rules.Card exposing (..)
