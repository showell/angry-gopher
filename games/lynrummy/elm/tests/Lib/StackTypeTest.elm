module Lib.StackTypeTest exposing (suite)

{-| Tests for `Lib.Rules.StackType`. Ported from
...
import Expect
import Lib.Rules.Card exposing (Card, CardValue(..), OriginDeck(..), Suit(..), allCardValues, allSuits, cardFromLabel, valueStr)
