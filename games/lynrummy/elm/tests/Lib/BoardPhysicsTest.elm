module Lib.BoardPhysicsTest exposing (suite)

{-| Tests for `Lib.BoardPhysics`. No direct TS test
...
import Expect
import Lib.Physics.BoardPhysics exposing (canExtract, joinAdjacentRuns)
import Lib.Rules.Card exposing (Card, CardValue(..), OriginDeck(..), Suit(..), cardFromLabel)
