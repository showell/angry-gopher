...
scenario baseline_board_ACp
  desc: Baseline board, trouble AC'. no plan.
  op: solve
  helper:
    at (0,0): KS AS 2S 3S
    at (0,0): TD JD QD KD
...
scenario baseline_board_2Cp
  desc: Baseline board, trouble 2C'. no plan.
  op: solve
  helper:
    at (0,0): KS AS 2S 3S
    at (0,0): TD JD QD KD
...
scenario baseline_board_3C
  desc: Baseline board, trouble 3C. 4-step plan.
  op: solve
  helper:
    at (0,0): KS AS 2S 3S
    at (0,0): TD JD QD KD
...
scenario baseline_board_4Cp
  desc: Baseline board, trouble 4C'. 1-step plan.
  op: solve
  helper:
    at (0,0): KS AS 2S 3S
    at (0,0): TD JD QD KD
...
scenario baseline_board_5C
  desc: Baseline board, trouble 5C. no plan.
  op: solve
  helper:
    at (0,0): KS AS 2S 3S
    at (0,0): TD JD QD KD
...
scenario baseline_board_6C
  desc: Baseline board, trouble 6C. no plan.
  op: solve
  helper:
    at (0,0): KS AS 2S 3S
    at (0,0): TD JD QD KD
...
scenario baseline_board_7Cp
  desc: Baseline board, trouble 7C'. no plan.
  op: solve
  helper:
    at (0,0): KS AS 2S 3S
    at (0,0): TD JD QD KD
...
scenario baseline_board_8C
  desc: Baseline board, trouble 8C. 1-step plan.
  op: solve
  helper:
    at (0,0): KS AS 2S 3S
    at (0,0): TD JD QD KD
...
scenario baseline_board_9C
  desc: Baseline board, trouble 9C. no plan.
  op: solve
  helper:
    at (0,0): KS AS 2S 3S
    at (0,0): TD JD QD KD
...
scenario baseline_board_TC
  desc: Baseline board, trouble TC. no plan.
  op: solve
  helper:
    at (0,0): KS AS 2S 3S
    at (0,0): TD JD QD KD
...
scenario baseline_board_JC
  desc: Baseline board, trouble JC. no plan.
  op: solve
  helper:
    at (0,0): KS AS 2S 3S
    at (0,0): TD JD QD KD
...
scenario baseline_board_QC
  desc: Baseline board, trouble QC. 4-step plan.
  op: solve
  helper:
    at (0,0): KS AS 2S 3S
    at (0,0): TD JD QD KD
...
scenario baseline_board_KC
  desc: Baseline board, trouble KC. 2-step plan.
  op: solve
  helper:
    at (0,0): KS AS 2S 3S
    at (0,0): TD JD QD KD
...
scenario baseline_board_ADp
  desc: Baseline board, trouble AD'. 1-step plan.
  op: solve
  helper:
    at (0,0): KS AS 2S 3S
    at (0,0): TD JD QD KD
...
scenario baseline_board_2D
  desc: Baseline board, trouble 2D. 4-step plan.
  op: solve
  helper:
    at (0,0): KS AS 2S 3S
    at (0,0): TD JD QD KD
...
scenario baseline_board_3Dp
  desc: Baseline board, trouble 3D'. no plan.
  op: solve
  helper:
    at (0,0): KS AS 2S 3S
    at (0,0): TD JD QD KD
...
scenario baseline_board_4D
  desc: Baseline board, trouble 4D. no plan.
  op: solve
  helper:
    at (0,0): KS AS 2S 3S
    at (0,0): TD JD QD KD
...
scenario baseline_board_5D
  desc: Baseline board, trouble 5D. 1-step plan.
  op: solve
  helper:
    at (0,0): KS AS 2S 3S
    at (0,0): TD JD QD KD
...
scenario baseline_board_6D
  desc: Baseline board, trouble 6D. no plan.
  op: solve
  helper:
    at (0,0): KS AS 2S 3S
    at (0,0): TD JD QD KD
...
scenario baseline_board_7Dp
  desc: Baseline board, trouble 7D'. 3-step plan.
  op: solve
  helper:
    at (0,0): KS AS 2S 3S
    at (0,0): TD JD QD KD
...
scenario baseline_board_8D
  desc: Baseline board, trouble 8D. no plan.
  op: solve
  helper:
    at (0,0): KS AS 2S 3S
    at (0,0): TD JD QD KD
...
scenario baseline_board_9D
  desc: Baseline board, trouble 9D. 1-step plan.
  op: solve
  helper:
    at (0,0): KS AS 2S 3S
    at (0,0): TD JD QD KD
...
scenario baseline_board_TDp
  desc: Baseline board, trouble TD'. no plan.
  op: solve
  helper:
    at (0,0): KS AS 2S 3S
    at (0,0): TD JD QD KD
...
scenario baseline_board_JDp
  desc: Baseline board, trouble JD'. no plan.
  op: solve
  helper:
    at (0,0): KS AS 2S 3S
    at (0,0): TD JD QD KD
...
scenario baseline_board_QDp
  desc: Baseline board, trouble QD'. no plan.
  op: solve
  helper:
    at (0,0): KS AS 2S 3S
    at (0,0): TD JD QD KD
...
scenario baseline_board_KDp
  desc: Baseline board, trouble KD'. no plan.
  op: solve
  helper:
    at (0,0): KS AS 2S 3S
    at (0,0): TD JD QD KD
...
scenario baseline_board_ASp
  desc: Baseline board, trouble AS'. 1-step plan.
  op: solve
  helper:
    at (0,0): KS AS 2S 3S
    at (0,0): TD JD QD KD
...
scenario baseline_board_2Sp
  desc: Baseline board, trouble 2S'. no plan.
  op: solve
  helper:
    at (0,0): KS AS 2S 3S
    at (0,0): TD JD QD KD
...
scenario baseline_board_3Sp
  desc: Baseline board, trouble 3S'. no plan.
  op: solve
  helper:
    at (0,0): KS AS 2S 3S
    at (0,0): TD JD QD KD
...
scenario baseline_board_4S
  desc: Baseline board, trouble 4S. 1-step plan.
  op: solve
  helper:
    at (0,0): KS AS 2S 3S
    at (0,0): TD JD QD KD
...
scenario baseline_board_5S
  desc: Baseline board, trouble 5S. 4-step plan.
  op: solve
  helper:
    at (0,0): KS AS 2S 3S
    at (0,0): TD JD QD KD
...
scenario baseline_board_6Sp
  desc: Baseline board, trouble 6S'. no plan.
  op: solve
  helper:
    at (0,0): KS AS 2S 3S
    at (0,0): TD JD QD KD
...
scenario baseline_board_7Sp
  desc: Baseline board, trouble 7S'. no plan.
  op: solve
  helper:
    at (0,0): KS AS 2S 3S
    at (0,0): TD JD QD KD
...
scenario baseline_board_8S
  desc: Baseline board, trouble 8S. 1-step plan.
  op: solve
  helper:
    at (0,0): KS AS 2S 3S
    at (0,0): TD JD QD KD
...
scenario baseline_board_9S
  desc: Baseline board, trouble 9S. no plan.
  op: solve
  helper:
    at (0,0): KS AS 2S 3S
    at (0,0): TD JD QD KD
...
scenario baseline_board_TS
  desc: Baseline board, trouble TS. no plan.
  op: solve
  helper:
    at (0,0): KS AS 2S 3S
    at (0,0): TD JD QD KD
...
scenario baseline_board_JS
  desc: Baseline board, trouble JS. no plan.
  op: solve
  helper:
    at (0,0): KS AS 2S 3S
    at (0,0): TD JD QD KD
...
scenario baseline_board_QS
  desc: Baseline board, trouble QS. 1-step plan.
  op: solve
  helper:
    at (0,0): KS AS 2S 3S
    at (0,0): TD JD QD KD
...
scenario baseline_board_KSp
  desc: Baseline board, trouble KS'. no plan.
  op: solve
  helper:
    at (0,0): KS AS 2S 3S
    at (0,0): TD JD QD KD
...
scenario baseline_board_AHp
  desc: Baseline board, trouble AH'. 1-step plan.
  op: solve
  helper:
    at (0,0): KS AS 2S 3S
    at (0,0): TD JD QD KD
...
scenario baseline_board_2Hp
  desc: Baseline board, trouble 2H'. 4-step plan.
  op: solve
  helper:
    at (0,0): KS AS 2S 3S
    at (0,0): TD JD QD KD
...
scenario baseline_board_3Hp
  desc: Baseline board, trouble 3H'. no plan.
  op: solve
  helper:
    at (0,0): KS AS 2S 3S
    at (0,0): TD JD QD KD
...
scenario baseline_board_4Hp
  desc: Baseline board, trouble 4H'. no plan.
  op: solve
  helper:
    at (0,0): KS AS 2S 3S
    at (0,0): TD JD QD KD
...
scenario baseline_board_5Hp
  desc: Baseline board, trouble 5H'. 1-step plan.
  op: solve
  helper:
    at (0,0): KS AS 2S 3S
    at (0,0): TD JD QD KD
...
scenario baseline_board_6H
  desc: Baseline board, trouble 6H. no plan.
  op: solve
  helper:
    at (0,0): KS AS 2S 3S
    at (0,0): TD JD QD KD
...
scenario baseline_board_7Hp
  desc: Baseline board, trouble 7H'. 1-step plan.
  op: solve
  helper:
    at (0,0): KS AS 2S 3S
    at (0,0): TD JD QD KD
...
scenario baseline_board_8H
  desc: Baseline board, trouble 8H. no plan.
  op: solve
  helper:
    at (0,0): KS AS 2S 3S
    at (0,0): TD JD QD KD
...
scenario baseline_board_9H
  desc: Baseline board, trouble 9H. no plan.
  op: solve
  helper:
    at (0,0): KS AS 2S 3S
    at (0,0): TD JD QD KD
...
scenario baseline_board_TH
  desc: Baseline board, trouble TH. no plan.
  op: solve
  helper:
    at (0,0): KS AS 2S 3S
    at (0,0): TD JD QD KD
...
scenario baseline_board_JH
  desc: Baseline board, trouble JH. no plan.
  op: solve
  helper:
    at (0,0): KS AS 2S 3S
    at (0,0): TD JD QD KD
...
scenario baseline_board_QH
  desc: Baseline board, trouble QH. no plan.
  op: solve
  helper:
    at (0,0): KS AS 2S 3S
    at (0,0): TD JD QD KD
...
scenario baseline_board_KH
  desc: Baseline board, trouble KH. 2-step plan.
  op: solve
  helper:
    at (0,0): KS AS 2S 3S
    at (0,0): TD JD QD KD
