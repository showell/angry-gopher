...
"""
    ...
    , ( "planner_puzzles.dsl"
      , """# Each scenario captures the TS solver's plan for one entry
# in games/lynrummy/puzzles/puzzles.json. Auto-generated by
# games/lynrummy/ts/tools/replay_puzzles.ts.

scenario puzzle_a3_001_seed1
  desc: Replay of a3_001_seed1 (3-line).
  op: solve
  helper:
    at (0,0): 7S 7D 7C
    at (0,0): AS 2S 3S
...
scenario puzzle_a3_002_seed2
  desc: Replay of a3_002_seed2 (3-line).
  op: solve
  helper:
    at (0,0): 7S 7D 7C
    at (0,0): TH TC' TS
...
scenario puzzle_a3_003_seed3
  desc: Replay of a3_003_seed3 (3-line).
  op: solve
  helper:
    at (0,0): KS AS 2S 3S
    at (0,0): 2H 3H 4H
...
scenario puzzle_a3_004_seed4
  desc: Replay of a3_004_seed4 (3-line).
  op: solve
  helper:
    at (0,0): TD JD QD KD
    at (0,0): 7S 7D 7C
...
scenario puzzle_a3_005_seed5
  desc: Replay of a3_005_seed5 (3-line).
  op: solve
  helper:
    at (0,0): KH KC' KD
    at (0,0): 4H' 4D' 4C
...
"""
    ...
    , ( "puzzle_walkthroughs.dsl"
      , """# Per-puzzle replay-invariant walkthrough: solve the board and
# pin the full primitive sequence. The runner asserts the replay
# FSM and the eager applier agree on the final model AND that
# the puzzle ends in victory. Auto-generated by
# games/lynrummy/ts/tools/replay_puzzles.ts.
