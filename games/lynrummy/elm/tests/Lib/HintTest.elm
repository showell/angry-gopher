module Lib.HintTest exposing (suite)

{-| Tests for Lib.Strategy.Hint.buildSuggestions. Mirrors
...
import Lib.Strategy.Hint as Hint
...
suite : Test
suite =
    describe "Lib.Strategy.Hint.buildSuggestions"
        [ emptyHand
