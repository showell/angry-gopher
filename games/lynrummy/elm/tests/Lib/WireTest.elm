module Lib.WireTest exposing (suite)
...
import Lib.Physics.BoardGeometry exposing (BoardBounds, GeometryError, GeometryErrorKind(..), boardBoundsDecoder, encodeBoardBounds, encodeGeometryError, geometryErrorDecoder)
import Lib.Rules.Card exposing (Card, CardValue(..), OriginDeck(..), Suit(..), cardDecoder, encodeCard)
