module Lib.ConformanceTests exposing (suite)

{-| End-to-end conformance test runner.

Parses every embedded `.dsl` file in `Lib.DslContent.allFiles`
via `Lib.ConformanceDsl.parseConformanceDsl`, then dispatches
