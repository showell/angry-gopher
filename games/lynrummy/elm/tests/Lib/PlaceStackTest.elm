module Lib.PlaceStackTest exposing (suite)

{-| Pure-Elm tests for `Lib.PlaceStack` math that doesn't
...
generated into `Lib.DslConformanceTest`.
-}

import Expect
import Lib.Physics.PlaceStack as PS
import Test exposing (Test, describe, test)


suite : Test
suite =
    describe "Lib.PlaceStack"
        [ stackWidthTests ]
