module LynRummy.DealerTest exposing (suite)

{-| Tests for LynRummy.Dealer — especially the seed-driven
...
import Expect
import LynRummy.Card as Card exposing (OriginDeck(..), Suit(..))
import LynRummy.CardStack as CardStack exposing (CardStack)
import LynRummy.Dealer as Dealer
import LynRummy.Hand as Hand
import LynRummy.Random as Random
import Test exposing (Test, describe, test)


suite : Test
suite =
    describe "LynRummy.Dealer.dealFullGame"
        [ cardConservation
        , stackShapes
        , handSizes
        , determinism
