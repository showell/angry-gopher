module LynRummy.GameTest exposing (suite)

{-| Tests for LynRummy.Game.applyCompleteTurn — the autonomous
...
import LynRummy.CardStack exposing (HandCard, HandCardState(..))
import LynRummy.Game as Game exposing (GameState)
...
suite : Test
suite =
    describe "LynRummy.Game.applyCompleteTurn"
        [ seatAndTurn
        , cardsPlayedBranches
        , deckDrawBranches
        , scoringBranches
