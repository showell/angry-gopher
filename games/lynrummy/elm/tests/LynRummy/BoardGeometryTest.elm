module LynRummy.BoardGeometryTest exposing (suite)

{-| Tests for `LynRummy.BoardGeometry`. Ported from
...
import LynRummy.Card exposing (CardValue(..), OriginDeck(..), Suit(..))
...
suite : Test
suite =
    describe "LynRummy.BoardGeometry"
        [ validBoardsTests
        , outOfBoundsTests
        , overlapTests
        , classificationTests
