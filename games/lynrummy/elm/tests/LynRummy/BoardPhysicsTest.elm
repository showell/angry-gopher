module LynRummy.BoardPhysicsTest exposing (suite)

{-| Tests for `LynRummy.BoardPhysics`. No direct TS test
...
import Expect
import LynRummy.BoardPhysics exposing (canExtract, joinAdjacentRuns)
...
suite : Test
suite =
    describe "LynRummy.BoardPhysics"
        [ canExtractTests
