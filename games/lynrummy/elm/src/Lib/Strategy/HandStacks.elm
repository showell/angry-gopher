module Lib.Strategy.HandStacks exposing (trick)
...
import Lib.Rules.Card exposing (cardValueToInt, suitToInt)
import Lib.CardStack exposing (CardStack, HandCard)
import Lib.Rules.StackType exposing (CardStackType(..), getStackType)
import Lib.Strategy.Helpers exposing (freshlyPlayed, pushNewStack)
                    ...
                    case current of
                        ...
                        prev :: _ ->
                            let
                                ...
                                colorOK =
                                    Lib.Rules.Card.suitColor hc.card.suit
                                        /= Lib.Rules.Card.suitColor prev.card.suit
                            in
