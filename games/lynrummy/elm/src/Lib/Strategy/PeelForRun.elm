module Lib.Strategy.PeelForRun exposing (trick)
...
import Lib.Rules.Card exposing (Card, cardValueToInt)
import Lib.CardStack exposing (CardStack, HandCard, canExtract)
...
import Lib.Strategy.Helpers exposing (extractCard, freshlyPlayed, pushNewStack)
import Lib.Strategy.Trick exposing (Play, Trick)
