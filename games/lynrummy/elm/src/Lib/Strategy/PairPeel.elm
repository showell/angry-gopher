module Lib.Strategy.PairPeel exposing (trick)
...
import Lib.Rules.StackType exposing (CardStackType(..), getStackType, predecessor, successor)
import Lib.Strategy.Helpers exposing (dummyLoc, extractCard, freshlyPlayed)
