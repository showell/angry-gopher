...
`WingId` from `Lib.Physics.WingOracle`, and rendered with
...
import Lib.CardStack as CardStack exposing (BoardLocation)
import Lib.Physics.BoardGeometry as BG
import Lib.Physics.WingOracle as WingOracle exposing (WingId)
