...
Elm primitives already in place (`LynRummy.Score`,
`LynRummy.PlayerTurn`, `LynRummy.Hand`, `CardStack.agedFromPriorTurn`).
...
import LynRummy.CardStack as CardStack exposing (CardStack, HandCardState(..))
import LynRummy.Hand as Hand exposing (Hand)
import LynRummy.PlayerTurn as PlayerTurn exposing (CompleteTurnResult(..))
