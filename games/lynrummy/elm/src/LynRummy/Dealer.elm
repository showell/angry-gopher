module LynRummy.Dealer exposing
    ( GameSetup
    , dealFullGame
    , initialBoard
    , openingHand
...
Elm shuffles with Mulberry32 (`LynRummy.Random`). Same seed →
...
import LynRummy.CardStack as CardStack exposing (BoardCardState(..), BoardLocation, CardStack)
