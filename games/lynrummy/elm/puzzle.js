...
var $author$project$Game$Rules$Card$Heart = {$: 'Heart'};
var $author$project$Game$Rules$Card$King = {$: 'King'};
var $author$project$Game$Rules$Card$Nine = {$: 'Nine'};
var $author$project$Game$Rules$Card$Queen = {$: 'Queen'};
var $author$project$Game$Rules$Card$Seven = {$: 'Seven'};
var $author$project$Game$Rules$Card$Two = {$: 'Two'};
var $author$project$Game$Rules$Card$DeckOne = {$: 'DeckOne'};
var $author$project$Game$CardStack$FirmlyOnBoard = {$: 'FirmlyOnBoard'};
var $author$project$Puzzle$stackAt = F3(
	function (top, left, valuesAndSuits) {
		return {
			boardCards: A2(
				$elm$core$List$map,
				function (_v0) {
					...
					var s = _v0.b;
					return {
						card: {originDeck: $author$project$Game$Rules$Card$DeckOne, suit: s, value: v},
						state: $author$project$Game$CardStack$FirmlyOnBoard
					};
				},
				valuesAndSuits),
...
var $author$project$Puzzle$puzzleStacks = _List_fromArray(
	[
		A3(
		$author$project$Puzzle$stackAt,
		100,
		100,
		_List_fromArray(
			[
				_Utils_Tuple2($author$project$Game$Rules$Card$Seven, $author$project$Game$Rules$Card$Heart),
				_Utils_Tuple2($author$project$Game$Rules$Card$Eight, $author$project$Game$Rules$Card$Heart),
				_Utils_Tuple2($author$project$Game$Rules$Card$Nine, $author$project$Game$Rules$Card$Heart)
			])),
		A3(
		$author$project$Puzzle$stackAt,
		220,
		...
		_List_fromArray(
			[
				_Utils_Tuple2($author$project$Game$Rules$Card$King, $author$project$Game$Rules$Card$Club),
				_Utils_Tuple2($author$project$Game$Rules$Card$Ace, $author$project$Game$Rules$Card$Club),
				_Utils_Tuple2($author$project$Game$Rules$Card$Two, $author$project$Game$Rules$Card$Club)
			])),
		A3(
		$author$project$Puzzle$stackAt,
		340,
...
var $author$project$Game$Rules$Card$Black = {$: 'Black'};
var $author$project$Game$Rules$Card$Red = {$: 'Red'};
var $author$project$Game$Rules$Card$suitColor = function (suit) {
	switch (suit.$) {
		case 'Club':
			return $author$project$Game$Rules$Card$Black;
		case 'Spade':
			return $author$project$Game$Rules$Card$Black;
		case 'Diamond':
			return $author$project$Game$Rules$Card$Red;
		default:
			return $author$project$Game$Rules$Card$Red;
	}
};
var $author$project$Game$Rules$Card$cardColor = function (card) {
	return $author$project$Game$Rules$Card$suitColor(card.suit);
};
var $author$project$Game$Rules$Card$isPairOfDups = F2(
	function (a, b) {
		return _Utils_eq(a.value, b.value) && _Utils_eq(a.suit, b.suit);
	});
var $elm$core$Basics$neq = _Utils_notEqual;
var $author$project$Game$Rules$Card$Five = {$: 'Five'};
var $author$project$Game$Rules$Card$Four = {$: 'Four'};
var $author$project$Game$Rules$Card$Jack = {$: 'Jack'};
var $author$project$Game$Rules$Card$Six = {$: 'Six'};
var $author$project$Game$Rules$Card$Ten = {$: 'Ten'};
var $author$project$Game$Rules$Card$Three = {$: 'Three'};
var $author$project$Game$Rules$StackType$successor = function (v) {
	switch (v.$) {
		case 'Ace':
			return $author$project$Game$Rules$Card$Two;
		case 'Two':
			return $author$project$Game$Rules$Card$Three;
		case 'Three':
			return $author$project$Game$Rules$Card$Four;
		case 'Four':
			return $author$project$Game$Rules$Card$Five;
		case 'Five':
			return $author$project$Game$Rules$Card$Six;
		case 'Six':
			return $author$project$Game$Rules$Card$Seven;
		case 'Seven':
			return $author$project$Game$Rules$Card$Eight;
		case 'Eight':
			return $author$project$Game$Rules$Card$Nine;
		case 'Nine':
			return $author$project$Game$Rules$Card$Ten;
		case 'Ten':
			return $author$project$Game$Rules$Card$Jack;
		case 'Jack':
			return $author$project$Game$Rules$Card$Queen;
		case 'Queen':
			return $author$project$Game$Rules$Card$King;
		default:
			return $author$project$Game$Rules$Card$Ace;
	}
};
var $author$project$Game$Rules$StackType$cardPairStackType = F2(
	function (a, b) {
		return A2($author$project$Game$Rules$Card$isPairOfDups, a, b) ? $author$project$Game$Rules$StackType$Dup : (_Utils_eq(a.value, b.value) ? $author$project$Game$Rules$StackType$Set : (_Utils_eq(
			b.value,
			$author$project$Game$Rules$StackType$successor(a.value)) ? (_Utils_eq(a.suit, b.suit) ? $author$project$Game$Rules$StackType$PureRun : ((!_Utils_eq(
...
var $author$project$Game$Rules$StackType$hasDuplicateCards = function (cards) {
	if (!cards.b) {
		...
		return A2(
			$elm$core$List$any,
			$author$project$Game$Rules$Card$isPairOfDups(first),
			rest) || $author$project$Game$Rules$StackType$hasDuplicateCards(rest);
	}
};
var $author$project$Game$Rules$StackType$isFollowsConsistentPattern = F2(
	function (stackType, cards) {
		if (cards.b && cards.b.b) {
			...
			var rest = _v1.b;
			return _Utils_eq(
				A2($author$project$Game$Rules$StackType$cardPairStackType, a, b),
				stackType) && A2(
				$author$project$Game$Rules$StackType$isFollowsConsistentPattern,
				stackType,
...
var $author$project$Game$Rules$StackType$getStackType = function (cards) {
	if (!cards.b) {
		...
		if (!cards.b.b) {
			...
			var _v1 = cards.b;
			var b = _v1.a;
			var provisional = A2($author$project$Game$Rules$StackType$cardPairStackType, a, b);
			switch (provisional.$) {
				case 'Bogus':
					return $author$project$Game$Rules$StackType$Bogus;
				case 'Dup':
					return $author$project$Game$Rules$StackType$Dup;
				default:
					return ($elm$core$List$length(cards) === 2) ? $author$project$Game$Rules$StackType$Incomplete : ((_Utils_eq(provisional, $author$project$Game$Rules$StackType$Set) && $author$project$Game$Rules$StackType$hasDuplicateCards(cards)) ? $author$project$Game$Rules$StackType$Dup : ((!A2($author$project$Game$Rules$StackType$isFollowsConsistentPattern, provisional, cards)) ? $author$project$Game$Rules$StackType$Bogus : provisional));
			}
		}
	}
};
...
var $author$project$Game$Rules$Card$valueStr = function (v) {
	switch (v.$) {
		case 'Ace':
			return 'A';
		case 'Two':
...
var $author$project$Game$Rules$Card$valueDisplayStr = function (v) {
	if (v.$ === 'Ten') {
		return '10';
	} else {
		return $author$project$Game$Rules$Card$valueStr(v);
	}
};
