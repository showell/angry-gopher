// Post-shift subproblem: shift already applied as line 1, only
// the 4-line continuation remains. Test with shift off, focus on.
...
const raw: RawBuckets = {
  helper: [
    P("3C","4C'","5C'"),
    P("KS","AS","2S"),       // post-shift: 3S out, KS in
    P("3D","4C","5H","6S","7D'"),
    P("7S","7D","7C","7H"),
    P("KH","AC","2H'"),
    P("AD'","2C","3D'"),     // post-shift: KS gone
    P("TD","JD","QD","KD"),
  ],
  trouble: [[p("AC'")], [p("AD")]],
  growing: [],
