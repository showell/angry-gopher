// State after manually applying:
//   1. steal 3S from [AS 2S 3S], absorb onto [4H 5S]  → [3S 4H 5S] complete; spawn [AS 2S]
//   2. peel  KS from [KS AD' 2C 3D'], absorb onto [AS 2S]  → [KS AS 2S] complete
// Now [KS AS 2S] is in COMPLETE (AS no longer extractable as donor).
...
const raw: RawBuckets = {
  helper: [
    ...
    P("7S","7D","7C","7H"),
    P("KH","AC","2H'"),
    P("AD'","2C","3D'"),         // was [KS AD' 2C 3D'], KS peeled
    P("TD","JD","QD","KD"),
  ],
  trouble: [[p("AC'")], [p("AD")]],
  growing: [],
