module LynRummy.StackTypeTest exposing (suite)

{-| Tests for `LynRummy.StackType`. Ported from
...
import Expect
import LynRummy.Card exposing (Card, CardValue(..), OriginDeck(..), Suit(..), allCardValues, cardFromLabel)
