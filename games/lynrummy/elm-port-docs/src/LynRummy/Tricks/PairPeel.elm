module LynRummy.Tricks.PairPeel exposing (trick)
...
import LynRummy.StackType exposing (CardStackType(..), getStackType, predecessor, successor)
import LynRummy.Tricks.Helpers exposing (dummyLoc, extractCard, freshlyPlayed)
