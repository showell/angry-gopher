...
// baked from a vendored emoji SVG (emoji_svg/*.svg — Twemoji + one Fluent bull, flat fill-only) into a flat list
...
//! Twemoji + Fluent — see emoji_svg/README.md for per-file source + licence.)
//!
