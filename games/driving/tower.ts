...
const BEACON_PERIOD = 120;       // frames for a full invisible -> bright -> invisible cycle (a brisk blink)
const BEACON_RADIUS = 3.0;       // 6m-diameter sphere, drawn as a flat disc
