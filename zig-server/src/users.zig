...
// name + password set, member lookup, deletion, plus a live session signer.
// The display-name POLICY is not here: it is pure, shared with the local player
// identity, and lives in names.zig.
