module LynRummy.CardTest exposing (suite)

{-| Tests for `LynRummy.Card`. Ported from
...
Divergences from the TS source:
  ...
  - `build_full_double_deck` tests now ported (ported
    2026-04-14 after `LynRummy.Random` landed). Takes an
